...
public sealed partial class MainWindow : Window
{
    ...
    private async void RootGrid_Loaded(object sender, RoutedEventArgs e)
    {
        ...
        WirePhoneManagementViewModel();
    }

    private void WirePhoneManagementViewModel()
    {
        var services = new PhoneManagementHostServices(
            () => _graphConnected,
            EnsurePowerShellReady,
            () => _ps!.GetGraphAccessTokenAsync(),
            () => _ps!.GetDialPlansAsync(),
            () => _ps!.GetVoiceRoutingPoliciesAsync(),
            AppendLog);

        PhoneManagementHost.DataContext = new PhoneManagementViewModel(services);
    }
